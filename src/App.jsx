  ...
  return (
    <Router basename={import.meta.env.BASE_URL}>
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col overflow-x-hidden">
        ...
        <footer className="bg-slate-900 border-t border-slate-800/50 py-12 mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-6">
            <a 
              href="https://discord.gg/5humW7QHkK" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold transition-all hover:scale-105"
            >
              <DiscordIcon className="w-5 h-5" />
              Join our Discord
            </a>
            <p className="text-slate-500 text-sm text-center">
              © 2026 Skyblock Guides. Not affiliated with Hypixel Inc.
            </p>
          </div>
        </footer>
      </div>
